...
async def recalc_order_status(oid: str):
    """Recalcula o estado da encomenda com base em plano, faturação e recebimentos."""
    ...
    invoiced_gross = sum(i["total_gross"] for i in invoices)
    ...
    if (
        ...
        and eq(invoiced_gross, received)
